...
const Blog = () => {
    ...
    return (
        <div className="container mx-auto flex flex-wrap pb-8 mt-5">
            ...
            {blogsState.blogs.map((item, index) => (
                <div className="w-full md:w-1/3 p-6 flex flex-col" key={index}>
                    ...
                    <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                        <div className="flex items-center justify-start gap-2">
                            ...
                            <button className="mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-1 py-1 px-4 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out" onClick={(e) => blogsState.handleDelete(e)} id={item.id}>
                                Delete
                            </button>
                            <button className="mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-1 py-1 px-4 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out" onClick={() => blogsState.handleEdit({ id: item.id })}>
                                Edit
                            </button>
                        </div>
                    </div>
